...
import static com.dmcd.amazonlogger.GUILogPanel.MsgType;
...
public class Variables {
    ...
    // This must be the same definition as used by the ScriptLauncher project
...
//        READONLY,   // only only local function can Write, local & called functions can Read
    ...
    Variables () {
        VarReserved varRes = new VarReserved();
    }

    /**
     * creates a new local allocation group for the specified subroutine.
     * 
     * @param subName - the subroutine name
     * 
     * @throws ParserException 
     */
    public static void allocateSubroutine(String subName) throws ParserException {
     ...
     * @throws ParserException 
     */
    public static boolean isLocalVarDefined (String subName, String varName) throws ParserException {
...
//        VarArray.resetUpdate();
     ...
     */
    public static void sendVarAlloc() {
    ...
    private static void setVarChange (String varName, VarClass cls) throws ParserException {
        if (AmazonReader.isOpModeNetwork()) {
            switch (cls) {
                case LOCAL:
     ...
     * @throws ParserException
     */
    public static void setStringVariable (String name, String value) throws ParserException {
     ...
     * @throws ParserException
     */
    public static void setIntegerVariable (String name, Long value) throws ParserException {
        VarClass cls = getVariableClass (name);
        switch (cls) {
            case LOCAL:
     ...
     * @throws ParserException
     */
    public static void setUnsignedVariable (String name, Long value) throws ParserException {
        VarClass cls = getVariableClass (name);
        switch (cls) {
            case LOCAL:
     ...
     * @throws ParserException
     */
    public static void setBooleanVariable (String name, Boolean value) throws ParserException {
        VarClass cls = getVariableClass (name);
        switch (cls) {
            case LOCAL:
    ...
    public static void setStrArray (String name, ArrayList<String> value) throws ParserException {
        VarClass cls = getVariableClass (name);
        switch (cls) {
            case LOCAL:
    ...
    public static void setIntArray (String name, ArrayList<Long> value) throws ParserException {
        VarClass cls = getVariableClass (name);
        switch (cls) {
            case LOCAL:
    ...
    public static String getStringValue (String name) throws ParserException {
    ...
    public static Long getIntegerValue (String name) throws ParserException {
        switch (getVariableClass (name)) {
            case LOCAL:
    ...
    public static Long getUnsignedValue (String name) throws ParserException {
        switch (getVariableClass (name)) {
            case LOCAL:
    ...
    public static Boolean getBooleanValue (String name) throws ParserException {
        switch (getVariableClass (name)) {
            case LOCAL:
     ...
     */
    public static void allocateVariable (String accStr, String dataType, String varName, String subName) throws ParserException {
        String functionId = CLASS_NAME + "." + Utils.getCurrentMethodName() + ": ";
     ...
     */
    public static int getStringSize (String name) throws ParserException {
     ...
     */
    public static ParameterStruct getVariableInfo (VarExtensions paramInfo) throws ParserException {
        String functionId = CLASS_NAME + "." + Utils.getCurrentMethodName() + ": ";
     ...
     * @throws ParserException 
     */
    public static ParameterStruct getReferenceValue (String varName) throws ParserException {
        String functionId = CLASS_NAME + "." + Utils.getCurrentMethodName() + ": ";
